...
统计7日京豆的变化情况，包括收入，支出，以及显示当前京豆数量,目前小问题:下单使用京豆后,退款重新购买会出现异常
...
async function bean() {
  ...
  const tm = parseInt((Date.now() + 28800000) / 86400000) * 86400000 - 28800000 - (24 * 60 * 60 * 1000)*7;
  // 今天0:0:0时间戳
  ...
  // console.log(`7日收入：${$.incomeBean}个京豆 🐶`);
  // console.log(`7日支出：${$.expenseBean}个京豆 🐶`)
}
function TotalBean() {
